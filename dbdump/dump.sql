...
--
-- Table structure for table `common_cat_fields`
--

DROP TABLE IF EXISTS `common_cat_fields`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `common_cat_fields` (
  ...
  PRIMARY KEY (`id`),
  KEY `category_id` (`category_id`),
  CONSTRAINT `common_cat_fields_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `common_cat_fields`
--

LOCK TABLES `common_cat_fields` WRITE;
/*!40000 ALTER TABLE `common_cat_fields` DISABLE KEYS */;
/*!40000 ALTER TABLE `common_cat_fields` ENABLE KEYS */;
UNLOCK TABLES;
